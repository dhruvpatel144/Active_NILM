...
def data_preprocess(only_positive=False):
    ...
    if only_positive:
        ...
        data_aggregated["aggr"] = (
            data_aggregated["clotheswasher1"]
            + data_aggregated["dishwasher1"]
            + data_aggregated["air1"]
            + data_aggregated["refrigerator1"]
            + data_aggregated["furnace1"]
        )
    else:
        data_aggregated = data_new.copy()
        data_aggregated["aggr"] = (
